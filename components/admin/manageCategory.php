                ...
                success: (response) => {
                    ...
                    if (data == "No data found") {
                        ...
                        data.forEach(function(item) {
                            ...
                            if (item.is_active == 1) {
                                html += `<a onclick="handleAction(${item.category_id}, 'delete')"><i class="mdi mdi-lock px-3 fs-5 text-danger"></i></a>`
                            } else {
                                html += `<a onclick="handleAction(${item.category_id}, 'undelete')"><i class="mdi mdi-lock-open px-3 fs-5 text-danger"></i></a>`
                            }
                            html += `
                                                    </div>
                                                </td>
